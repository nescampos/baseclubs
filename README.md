# BaseClubs
BaseClubs is an Investment Club platform to manage funds (treasury) in Base Network.
...
## URL and information
----
- Project URL: https://nescampos.github.io/baseclubs/
- Blockchain: Base Goerli Testnet
- Smart Contract ID: [0x4dA05ddA2F0586327E956548fd3E88a508ba2168](https://goerli.basescan.org/address/0x4dA05ddA2F0586327E956548fd3E88a508ba2168)
...
- **Join or leave clubs**: Anyone with a Base Network account can join the available investment clubs, as well as leave one, with just a couple of clicks.
